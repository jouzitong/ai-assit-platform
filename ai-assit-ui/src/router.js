...
import SystemOverviewPage from './views/domain/settings/system/pages/overview/overview.vue'
import SystemParamsPage from './views/domain/settings/system/pages/params/params.vue'
import SystemComponentsPage from './views/domain/settings/system/pages/components/components.vue'
import SystemPermissionsPage from './views/domain/settings/system/pages/permissions/permissions.vue'
import SystemAiPage from './views/domain/settings/system/pages/ai/ai.vue'
import SystemDataSourcePage from './views/domain/settings/system/pages/data-source/data-source.vue'
import SystemDataSourceManagePage from './views/domain/settings/system/pages/data-source/manage/manage.vue'
