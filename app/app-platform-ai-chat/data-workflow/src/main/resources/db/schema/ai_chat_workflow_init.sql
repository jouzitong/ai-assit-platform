...
VALUES ('ai-query-workflow-default', 'chat-message', 1, 'query-planning', 1,
       ...
       ('ai-query-workflow-default', 'query-planning', 2, 'sql-generate', 1,
        ...
        0, 0),
       ('ai-query-workflow-default', 'sql-generate', 3, 'sql-validate', 1,
        ...
        0, 0),
       ('ai-query-workflow-default', 'sql-validate', 4, 'sql-execute', 1,
        ...
        0, 0),
       ('ai-query-workflow-default', 'sql-execute', 5, 'render', 1,
        ...
        0, 0),
       ('ai-query-workflow-default', 'render', 6, NULL, 1,
