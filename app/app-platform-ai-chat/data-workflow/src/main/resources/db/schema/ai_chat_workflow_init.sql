...
VALUES ('ai-query-workflow-default', 'chat-message', 1, 'query-planning', 1,
        '{"summary":"会话初始化","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'query-planning', 2, 'knowledge-search', 1,
        '{"summary":"查询规划","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'knowledge-search', 3, 'sql-generate', 1,
        '{"summary":"知识检索","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'sql-generate', 4, 'sql-validate', 1,
        '{"summary":"SQL生成","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'sql-validate', 5, 'sql-execute', 1,
        '{"summary":"SQL校验","executeMode":"LOOP","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'sql-execute', 6, 'render', 1,
        '{"summary":"SQL执行","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0),
       ('ai-query-workflow-default', 'render', 7, NULL, 1,
        '{"summary":"结果渲染","executeMode":"SERIAL","inputDefinitions":[],"outputDefinitions":[],"options":{},"ext":{}}',
        0, 0)
...
VALUES ('ai-query-workflow-default', 'query-planning', 'business_term_resolve', 'BEFORE_EXECUTE', 1, 1,
        '{"required":false,"options":{},"ext":{}}', 0, 0),
       ('ai-query-workflow-default', 'query-planning', 'time_range_normalize', 'BEFORE_EXECUTE', 2, 1,
        '{"required":false,"options":{},"ext":{}}', 0, 0),
       ('ai-query-workflow-default', 'query-planning', 'query_plan_review', 'REVIEW_OUTPUT', 3, 1,
        '{"required":false,"options":{},"ext":{}}', 0, 0),
       ('ai-query-workflow-default', 'sql-generate', 'sql_generation_policy', 'BEFORE_EXECUTE', 1, 1,
        '{"required":false,"options":{},"ext":{}}', 0, 0),
       ('ai-query-workflow-default', 'sql-generate', 'user_preference_resolve', 'BEFORE_EXECUTE', 2, 1,
        '{"required":false,"options":{},"ext":{}}', 0, 0)
ON DUPLICATE KEY UPDATE sort       = VALUES(sort),
                        enabled    = VALUES(enabled),
                        config     = VALUES(config),
