...
public class AiChatRoundEntity extends LogicalDeleteEntity {
     ...
     * 对话轮次唯一编码。
     */
    @JdbcColumn(name = "round_code", unique = true, comment = "对话轮次唯一编码。")
     ...
     */
    @JdbcColumn(name = "round_type", comment = "轮次类型，用于区分普通问答、重试、追问、工具执行、流程节点执行等不同轮次场景。")
     ...
     */
    @JdbcColumn(name = "parent_round_code", comment = "父轮次编码，用于建立轮次之间的上下文或派生关系。")
     ...
     */
    @JdbcColumn(name = "session_code", comment = "会话编码，用于标识当前轮次所属的完整会话。")
     ...
     * 用户 ID，用于标识当前轮次所属用户。
     */
    @JdbcColumn(name = "user_id", comment = "用户 ID，用于标识当前轮次所属用户。")
    @TableField("user_id")
    private Long userId;
     ...
     */
    @JdbcColumn(name = "model_code", comment = "模型配置编码，表示当前轮次期望使用的模型配置。")
     ...
     */
    @JdbcColumn(name = "actual_model", comment = "实际调用的模型名称，用于记录最终真实执行的模型。")
     ...
     * 轮次状态，例如处理中、成功、失败、取消。
     */
    @JdbcColumn(name = "status", comment = "轮次状态，例如处理中、成功、失败、取消。")
    @TableField("status")
