...
import ai.platform.aiassit.conversation.controller.IAiChatConversationManageController;
...
@RestController
@AllArgsConstructor
public class AiChatConversationManageController implements IAiChatConversationManageController {
