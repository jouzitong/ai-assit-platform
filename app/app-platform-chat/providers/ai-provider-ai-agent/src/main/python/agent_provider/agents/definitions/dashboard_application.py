...
DASHBOARD_APPLICATION_AGENT = AgentDefinition(
    ...
    prompt=(
        ...
        "选择组件时必须读取 render-json-authoring skill 中冻结的组件说明、版本、参数和事件，"
        "不得根据模型记忆发明组件。RenderDocument 只能包含声明式结构，不得包含 SQL、函数、凭据、任意 URL 或请求地址。"
        ...
        "artifactType、contentFormat、content 表达。data-preview 必须使用 artifactType=JSON，content 原样保留"
